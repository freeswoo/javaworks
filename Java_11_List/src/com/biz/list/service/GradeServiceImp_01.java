...
public class GradeServiceImp_01 
	...
	public void view() {
		...
		for( GradeVO vo : gradeList) {
			...
			System.out.printf("%3s\t",vo.intKor);
			System.out.printf("%3s\t",vo.intEng);
			System.out.printf("%3s\t",vo.intMath);
			
			System.out.printf("%3s\t",vo.intTotal);
			System.out.printf("%3s\t",vo.intAvg);
