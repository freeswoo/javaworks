...
public class BankAccServiceV2 implements BankAccService {
	...
	public boolean viewAcc() throws Exception {
		...
		// 만약 strNum 계좌가 bankList에 있으면 해당 계좌 정보가
		//   bankAccVO에 담길것이고
		// 그렇치 않으면 bankAccVO에는 null 값이 담길 것이다.
		
		if(bankAccVO != null) {
			System.out.println("================================");
			System.out.println("계좌변호 :" + bankAccVO.getNum());
	...
	public void input() throws Exception {
		...
		if(bankAccVO != null) {
			...
			// DecimalFormat
			// 숫자값을 3000 = 3,000으로 바꿀때 사용했던 클래스와
			// 비슷한 기능으로
